...
class PopulateLegacyCourseCatalogue extends Command
{
        ...
        return [
            [
                ...
                'metadata' => $this->legacyMetadata(
                    catalogueTitle: 'AI Prompt Engineering 101',
            ...
            [
                ...
                'billing_type' => 'one_time', 'status' => 'active',
                'metadata' => $this->legacyMetadata(
                    catalogueTitle: 'E-Payment Fundamentals', individualTitle: 'E-Payment Fundamentals',
    ...
    private function careerMetadata(string $catalogueTitle, string $packageTitle, string $storeProductUrl): array
    {
        return [
            ...
            'pricing' => ['original_price' => 50, 'current_sale_price' => 19, 'currency' => 'USD'],
            'currency_note' => 'The canonical Laravel V2 course price is USD 19 with an original list price of USD 50.',
