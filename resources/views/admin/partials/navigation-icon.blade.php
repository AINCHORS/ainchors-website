@php
    $paths = [
        ...
        'consultations' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 4h14v16H5V4Zm3-2v4m8-4v4M8 10h8m-8 4h5"/>',
        'audit' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 3h10v4H7V3Zm-2 2h2m10 0h2v16H5V5Zm3 7 2 2 5-5"/>',
